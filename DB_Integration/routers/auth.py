...
async def create_user(db: user_dependency, create_user_request: CreateUserRequest):
    ...
    create_user_model = Users(
        ...
        is_active = True,
        phone_number = create_user_request.phone_number  # Store phone number
    )
...
async def login_for_access_token(form_data : Annotated[OAuth2PasswordRequestForm,Depends()],db:user_dependency):
